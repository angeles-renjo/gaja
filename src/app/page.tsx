...
const features = [
  ...
  },
  {
    id: 'food-costing',
    title: 'Food Costing',
    description: 'Track ingredient costs and calculate recipe pricing for better profitability',
    route: '/costing',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  },
  {
    id: 'users-management',
    title: 'Users/Staffs',
    description: 'Manage user accounts and assign roles to staff and administrators',
    route: '/admin/users',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
