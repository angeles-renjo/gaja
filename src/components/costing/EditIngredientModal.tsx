...
export default function EditIngredientModal({
  ...
  const updateIngredient = useMasterIngredientsStore((state) => state.updateIngredient);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await updateMasterIngredient(ingredient.id, {
      ...
      if (result.success && result.data) {
        updateIngredient(ingredient.id, result.data);
        onClose();
      } else {
